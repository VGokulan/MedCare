...
SECRET_KEY = "django-insecure-cm5je8ci@-k^xm5fo!kelx^9^k+5$p+kk!!cu095q)j-#ubx(r"
...
DATABASES = {
    "default": {
        ...
        "PORT": "5432",
        'OPTIONS': {
            'sslmode': 'require',   # Azure PG requires SSL
        },                                # From your PGPORT variable
    }
}
CACHES = {
    "default": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://127.0.0.1:6379/1", # /1 selects database 1
        "OPTIONS": {
